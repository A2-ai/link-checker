...
log_verbose "Fetching from: https://api.github.com/repos/a2-ai/link-checker/releases/latest"

github_response=$(curl -s https://api.github.com/repos/a2-ai/link-checker/releases/latest)
...
asset_url=$(echo "$github_response" | grep -o "https://github.com/A2-ai/link-checker/releases/download/.*$arch-$os_pattern.tar.gz")
...
if [ -z "$asset_url" ]; then
    ...
    echo "Please check available assets at https://github.com/a2-ai/link-checker/releases/latest" >&2
